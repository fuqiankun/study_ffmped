...
static void yuv444p_to_rgb24(AVPicture *dst, const AVPicture *src, int width,
														 int height) {
...
static void yuvj444p_to_rgb24(AVPicture *dst, const AVPicture *src, int width,
															int height) {
	const uint8_t *y1_ptr, *cb_ptr, *cr_ptr;
	uint8_t *d, *d1;
	int w, y, cb, cr, r_add, g_add, b_add;
...
static void rgb24_to_yuv444p(AVPicture *dst, const AVPicture *src, int width,
														 int height) {
	int src_wrap, x, y;
	int r, g, b;
	uint8_t *lum, *cb, *cr;
...
static void rgb24_to_yuvj420p(AVPicture *dst, const AVPicture *src, int width,
															int height) {
	int wrap, wrap3, width2;
	int r, g, b, r1, g1, b1, w;
	uint8_t *lum, *cb, *cr;
...
static void rgb24_to_yuvj444p(AVPicture *dst, const AVPicture *src, int width,
															int height) {
	int src_wrap, x, y;
	int r, g, b;
	uint8_t *lum, *cb, *cr;
...
static int glue(get_alpha_info_, RGB_NAME)(const AVPicture *src, int width,
																					 int height) {
	const unsigned char *p;
